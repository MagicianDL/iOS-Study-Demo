...
{
    // 1。创建soecket
    // TCP是基于数据流的，因此第二个参数使用SOCK_STREAM
    int error = -1;
    ...
    if (success) {
        ...
        peerAddr.sin_addr.s_addr = inet_addr("192.168.1.113");
...
- (void)UDPClient
{
    ...
    client_sockaddr.sin_addr.s_addr = inet_addr("192.168.1.113");
